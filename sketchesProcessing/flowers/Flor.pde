/*clase 'flor' contiene los tipos de flores que se dibujan y sus funciones
de crecimiento, aparicion, etc*/

//Declaracion de la clase
class Flor{ 


  //Declaracion de variables que comparten todos los objetos 'flor'
  color clr;
  float trans;
  float posx, posy;
  float numPet;
  ...
  //Constructor del objeto 'flor'
  Flor(float posX, float posY) 
  {
    ...
    velocidad = 4;                  /*  Velocidad de crecimiento de los 
                                        petalos*/
    easing = 0.05;
    offset = 0;
    overCircle = false;
